      ...
      <div className="auth-card">
        ...
        {success && (
          <div style={{
            ...
            borderRadius: 8, padding: '10px 14px', marginBottom: 16,
            fontSize: '0.875rem', color: 'var(--success)', display: 'flex', alignItems: 'center', gap: 8
          }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button className="oauth-btn" onClick={() => handleOAuth('google')} id="btn-signup-google">
          ...
          <button className="oauth-btn" onClick={() => handleOAuth('apple')} id="btn-signup-apple">
