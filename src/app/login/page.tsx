    ...
    <div className="auth-bg">
      <div className="auth-card">
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div className="form-group">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Link href="/forgot-password" style={{ fontSize: '0.75rem', color: 'var(--accent)' }}>
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button className="oauth-btn" onClick={() => handleOAuth('google')} id="btn-google-oauth">
          ...
          <button className="oauth-btn" onClick={() => handleOAuth('apple')} id="btn-apple-oauth">
